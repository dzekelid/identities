...
- name: AWS Simple Email Service API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/identity/master/_listings/aws-simple-email-service/action-setidentityfeedbackforwardingenabled-get.md
x-common:
- type: x-change-log
